...
async function main() {
    ...
    const obj = new GLParseVisitor().visit(parser(text))[0];

    // F|L|B|R|T|U
    const vertexData = obj.postions;
    const uvData = obj.texcoord;
    const normalData = obj.normals;
    ...
    mat4.perspective(projectionMatrix, 
        95 * Math.PI / 180, // vertical field-of-view (angle, radians)
        canvas.width / canvas.height, // aspect W/H
        1e-8, // near cull distance
        1e11 // far cull distance
    );
