...
// draw
function initBuffer(gl, vertices, colorData, uvData=0) {
...
const brick = loadTexture('img/front.png', gl1);
gl1.activeTexture(gl1.TEXTURE0);
gl1.bindTexture(gl1.TEXTURE_2D, brick);

const brick2 = loadTexture('img/rear.png', gl2);
gl2.activeTexture(gl2.TEXTURE0);
gl2.bindTexture(gl2.TEXTURE_2D, brick2);

var buffer1 = initBuffer(gl1, vertices, colorData, uvData)
...
const uvLocation = gl1.getAttribLocation(program1, `uv`)
gl1.enableVertexAttribArray(uvLocation);
gl1.bindBuffer(gl1.ARRAY_BUFFER, buffer1.uvBuffer)
gl1.vertexAttribPointer(uvLocation, 3, gl1.FLOAT, false, 0 ,0);


gl1.useProgram(program1);
gl1.enable(gl1.DEPTH_TEST);

var buffer2 = initBuffer(gl2, vertices, colorData, uvData)
...
const uvLocation2 = gl2.getAttribLocation(program2, `uv`)
gl2.enableVertexAttribArray(uvLocation2);
gl2.bindBuffer(gl2.ARRAY_BUFFER, buffer2.uvBuffer)
gl2.vertexAttribPointer(uvLocation2, 3, gl2.FLOAT, false, 0 ,0);
...
const uniformLocations = {
    ...
    textureID1: gl1.getUniformLocation(program1, "textureID"),
    textureID2: gl2.getUniformLocation(program2, "textureID"),
};
...
function draw_scene() {
   ...
   // mat4.rotateX(matrix, matrix, Math.PI/2 / 70);
    ...
    gl1.uniform1i(uniformLocations.textureID1,0);
    gl2.uniform1i(uniformLocations.textureID2,0);
